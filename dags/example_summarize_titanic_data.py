...
@dag(
    ...
    schedule=None,
    start_date=pendulum.from_format("2023-10-20", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "yashdeepsant@eaton.com": "mailto:yashdeepsant@eaton.com",
        "Open in Cloud IDE": "https://cloud.astronomer.io/cllyrswtd00k001mvcn1z9xau/cloud-ide/clnycmzqf006201nbjo6rorh5/clnycn086005i01nu7w0a81ul",
    },
)
